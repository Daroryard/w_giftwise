            ...
            <div class="card">
                <div class="card-body border-bottom">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0 card-title flex-grow-1">รับข่าวสารและไอเดีย</h5>
                    </div>
                </div>
                <div class="card-body">     
                    <div class="table-responsive">
                        <table id="table-mess" class="table align-middle table-nowrap table-hover">
                            <thead>
                                <tr>
                                    <th>E-mail</th>
                                    <th>Update</th>
                            ...
                            <tbody>
                                @foreach ($hd as $item)
                                    <tr>
                                        <td>
                                            {{$item->docu_newmessage_email}}
                                        </td>
                                        <td>
                                            <a href="{{route('newmessage.edit',$item->docu_newmessage_id)}}" class="btn btn-info"><i class="bx bx-edit"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
$(document).ready(function() {
        var table =  $('#table-mess').DataTable({
            order: [[ 1, 'asc' ]],
            columnDefs: [
