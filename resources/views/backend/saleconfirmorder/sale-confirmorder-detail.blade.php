            ...
            <div class="card">
                <div class="card-body border-bottom">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0 card-title flex-grow-1">Confirm Order</h5>
                    </div>
                </div>
                <div class="card-body">   
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="form-group row mb-4">
                                <label for="sal_confirmorder_hd_date" class="col-form-label col-lg-3">วันที่</label>
                                <div class="col-lg-9">
                                    <input type="date" class="form-control" name="sal_confirmorder_hd_date" id="sal_confirmorder_hd_date" value="{{ $hd->sal_confirmorder_hd_date }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-group row mb-4">
                                <label for="sal_confirmorder_hd_docuno" class="col-form-label col-lg-3">เลขที่</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="sal_confirmorder_hd_docuno" id="sal_confirmorder_hd_docuno" value="{{ $hd->sal_confirmorder_hd_docuno }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-group row mb-4">
                                <label for="sal_confirmorder_hd_duedate" class="col-form-label col-lg-3">กำหนดส่ง</label>
                                <div class="col-lg-9">
                                    <input type="date" class="form-control" name="sal_confirmorder_hd_duedate" id="sal_confirmorder_hd_duedate" value="{{ $hd->sal_confirmorder_hd_duedate }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group row mb-4">
                                <label for="sal_confirmorder_hd_save" class="col-form-label col-lg-3">ผู้ขาย</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="sal_confirmorder_hd_save" id="sal_confirmorder_hd_save" value="{{ $hd->sal_confirmorder_hd_save }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-group row mb-4">
                                <label for="transport_contact" class="col-form-label col-lg-3">ผู้ติดต่อการจัดส่ง</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="transport_contact" id="transport_contact" value="{{ $hd->transport_contact }}" readonly>
                                </div>
                            </div>
                        </div>                      
                    </div>
                    <div class="row">             
                        <div class="col-12 col-md-8">
                            <div class="form-group row mb-4">
                                <label for="transport_address" class="col-form-label col-lg-1">ที่อยู่จัดส่ง</label>
                                <div class="col-lg-11">
                                    <input type="text" class="form-control" name="transport_address" id="transport_address" value="{{ $hd->transport_address }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-group row mb-4">
                                <label for="sal_confirmorder_hd_pic2" class="col-form-label col-lg-3">เอกสาร Confirm</label>
                                <div class="col-lg-9">
                                    @if($hd->sal_confirmorder_hd_pic2)
                                    <a href="{{asset('https://erp.giftwise.co.th/'.$hd->sal_confirmorder_hd_pic2)}}" target="_blank">
                                ...
                                <tbody>
                                    @foreach ($dt as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{number_format($item->sal_confirmorder_dt_qty,2)}}/{{$item->ms_product_unit_name}}</td>
                                            <td>{{number_format($item->sal_confirmorder_dt_price,2)}}</td>
                                            <td>{{number_format($item->sal_confirmorder_dt_totaldiscount,2)}}</td>
                                            <td>{{number_format($item->sal_confirmorder_dt_netamount,2)}}</td>
                                            <td>
                                                @if($item->sal_confirmorder_dt_imgpic)
                                                <a href="{{asset('https://erp.giftwise.co.th/'.$item->sal_confirmorder_dt_imgpic)}}" target="_blank">
                                                    <i class="fas fa-file-pdf"></i>
                                                </a> 
                                                @endif
                                            </td>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-9">
                            ...
                            <label for="ms_customer_address" class="col-form-label">{{$hd->sal_confirmorder_hd_remark1}}</label><br>
                            <label for="ms_customer_address" class="col-form-label">{{$hd->sal_confirmorder_hd_remark2}}</label><br>
                            <label for="ms_customer_address" class="col-form-label">{{$hd->sal_confirmorder_hd_remark3}}</label>
                        </div>
                        <div class="col-12 col-md-3">
                            <div class="form-group row mb-4">
                                <label for="ms_customer_address" class="col-form-label col-lg-4">ฐานภาษี</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="ms_customer_address" id="ms_customer_address" value="{{number_format($hd->sal_confirmorder_hd_basevat)}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="ms_customer_address" class="col-form-label col-lg-4">ภาษี</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="ms_customer_address" id="ms_customer_address" value="{{number_format($hd->sal_confirmorder_hd_vat)}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="ms_customer_address" class="col-form-label col-lg-4">สุทธิ</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="ms_customer_address" id="ms_customer_address" value="{{number_format($hd->sal_confirmorder_hd_netamount)}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="ms_customer_address" class="col-form-label col-lg-4">ส่วนลด</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="ms_customer_address" id="ms_customer_address" value="{{number_format($hd->sal_confirmorder_hd_discount)}}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap table-hover">
                                ...
                                <tbody>
                                    @foreach ($tra as $key => $item)
                                        <tr>
                                            <td>{{$item->sal_confirmorder_sub_listno}}</td>
                                            <td>{{\Carbon\Carbon::parse($item->sal_confirmorder_sub_duedate)->format('d/m/Y')}}</td>
                                            <td>{{number_format($item->sal_confirmorder_sub_qty,2)}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
