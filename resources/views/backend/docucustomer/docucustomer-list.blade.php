            ...
            <div class="card">
                <div class="card-body border-bottom">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0 card-title flex-grow-1">ใบเสนอราคา</h5>
                    </div>
                </div>
                <div class="card-body">   
                            ...
                            <tbody>
                                @foreach ($hd as $item)
                                    <tr>
                                        ...
                                        <td>
                                            {{$item->docu_customer_companyemail}}
                                        </td>
                                        <td>
                                            {{$item->docu_customer_remark}}
                                        </td>
                                        <td>
                                            @if($item->docu_customer_design == 1)
                                            <span class="badge bg-success">Me Back</span>
                                            @else                                         
                                            <span class="badge bg-danger">No Need</span>
                                            @endif
                                             </td>
                                        </td>
                                        <td>
                                            @if($item->docu_customer_file)
                                            <a href="{{asset($item->docu_customer_file)}}" target="_blank">
                                        ...
                                        <td>
                                            <a href="{{route('docucustomer.edit',$item->docu_customer_id)}}" class="btn btn-info"><i class="bx bx-edit"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
