    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="outer-repeater needs-validation" novalidate action="{{ route('contact-us.update' , $hd->conf_contact_id) }}" method="POST"
                    ...
                    <div data-repeater-list="outer-group" class="outer">
                        <div data-repeater-item class="outer">
                            <div class="form-group row mb-4">
                                <label for="conf_contact_img" class="col-form-label col-lg-2">Contact Us Image {{$hd->conf_contact_type}}</label>
                                <div class="col-md-6 col-lg-5 mb-3 mb-md-0 mb-lg-0">
                                    <input name="conf_contact_img" class="form-control" id="conf_contact_img" type="file" accept="image/*" />
                                </div>
                                <div class="col-md-6 col-lg-5 text-center">
                                    <img class="img-fluid" src="{{ asset($hd->conf_contact_img) }}" width="250"
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <div class="form-check form-switch form-switch-md mt-1">
                                        <input class="form-check-input" type="checkbox" name="conf_contact_active" id="conf_contact_active" value="1" @if(old('conf_contact_active' ,  $hd->conf_contact_active) == 1 ) checked @endif>
                                        <label class="form-check-label" for="conf_contact_active"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
