            ...
            <div class="card">
                <div class="card-body border-bottom">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0 card-title flex-grow-1">Customer</h5>
                        <a href="{{ route('users-cust.create') }}" class="btn btn-primary"><i class="bx bx-edit"> เพิ่ม</i></a>
                    </div>
                </div>
                <div class="card-body">     
                    <div class="table-responsive">
                        <table id="table-cust" class="table align-middle table-nowrap table-hover">
                            <thead>
                                <tr>
                                    <th>Code</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                @foreach ($hd as $item)
                                    <tr>
                                        ...
                                        <td>
                                            {{$item->ms_customersub_email}}
                                        </td>
                                        <td>
                                            {{$item->ms_customersub_tel}}
                                        </td>
                                        <td>
                                            {{$item->sal_project_hd_save}}
                                        </td>
                                        <td>
