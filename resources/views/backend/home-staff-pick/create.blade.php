...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">ADD HOME STAFF PICK</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">DASHBOARD</a></li>
                        <li class="breadcrumb-item"><a href="javascript: void(0);">HOME STAFF PICK LISTS</a></li>
                        <li class="breadcrumb-item active">ADD HOME STAFF PICK</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form class="outer-repeater needs-validation" novalidate action="{{ route('home-staff-pick.store') }}" method="POST"
                        ...
                        <div data-repeater-list="outer-group" class="outer">
                            <div data-repeater-item class="outer">
                                <div class="form-group row mb-4">
                                    <label for="conf_homestaffpick_active" class="col-form-label col-lg-2">Homeslide Image</label>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="conf_homestaffpick_url" id="conf_homestaffpick_url" value="{{ old('conf_homestaffpick_url') }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-check form-switch form-switch-md mt-1">
                                            <input class="form-check-input" type="checkbox" name="conf_homestaffpick_active" id="conf_homestaffpick_active" @if(old('conf_homestaffpick_active')) checked @endif>
