                                                        ...
                                                        <li>
                                                            ...
                                                            @foreach ($categorie_sub as $key2 => $sub)
                                                                ...
                                                                <div class="col-xl-4">
                                                                    ...
                                                                    @if (app()->getLocale() == 'th')
                                                                        <a href="/{{app()->getLocale()}}/quickcategorysub/{{$sub->conf_category_id}}/-"><p>{{ $sub->conf_categorysub_name_th }}</p></a>
                                                                    @else
                                                                        <a href="/{{app()->getLocale()}}/quickcategorysub/{{$sub->conf_category_id}}/-"><p>{{ $sub->conf_categorysub_name_en }}</p></a>
                                                                    @endif
                                                                    </div>
                                                                </div>
                        ...
                        <nav class="nav nav-pills flex-column mt-3">
                            ...
                            <a class="nav-link" href="javascript:void(0)" onclick="playList('{{ $item->conf_category_id }}')">
                                <div class="rounded-3 row align-items-center">
                                    ...
                                    @endif
                                    <div class="position-relative col-1 float-right"><i class="fas fa-chevron-right text-white"></i></div>
                                    </p>
                                    <div class="position-relative col-1 text-right"></div>
                                </div>
                            </a>
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12 el-ft-q">
                        ...
                        <div class="row check-out">
                            <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;border-radius: 10px;">
                                ...
                                <div class="notify-error-ft-quo-name" hidden><p style="color:red">{{__('validation.home_aler_contact_name')}}</p></div>
                            </div>
                            <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;border-radius: 10px;">
                                ...
                                <div class="notify-error-ft-quo-email" hidden><p style="color:red">{{__('validation.home_aler_contact_email')}}</p></div>
                            </div>
                            <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;border-radius: 10px;">
                                ...
                                <div class="notify-error-ft-quo-company" hidden><p style="color:red">{{__('validation.home_aler_contact_company')}}</p></div>
                            </div>
                            <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;border-radius: 10px;">
                                ...
                                <div class="notify-error-ft-quo-tel" hidden><p style="color:red">{{__('validation.home_aler_contact_phone')}}</p></div>
                            </div>
                            <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;border-radius: 10px;">
                                ...
                                <div class="notify-error-ft-quo-remark" hidden><p style="color:red">{{__('validation.home_aler_contact_message')}}</p></div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="form-group mx-sm-3">
                            ...
                            <br>
                            <div class="notify-sub-error" hidden><p style="color:red">{{__('validation.home_subcribe_alert_email')}}</p></div>
                            <div class="notify-sub-duplicate" hidden><p style="color:red">{{__('validation.home_subcribe_alert_email_duplicate')}}</p></div>
                            <!-- button finish -->
