                            ...
                            <div class="col-sm-3 collection-filter">
                                ...
                                <div class="collection-filter-block">
                                    ...
                                    <div class="collection-collapse-block border-0 open">
                                        <h3 class="collapse-block-title">{{ __('validation.top_popular_search') }}</h3>
                                            ...
                                            <div class="product-top-filter">
                                                ...
                                                <div class="product-wrapper-grid product-load-more">
                                                    <div class="row margin-res">
                                                        @foreach ($pds as $item)
                                                        <div class="col-xl-3 col-6 col-grid-box-se">
                                                            <div class="product-box">
                                                                <div class="img-wrapper">
                                                                    <div class="front">
                                                                        <a href="/{{ app()->getLocale() }}/product/{{$item->conf_mainproduct_id}}/-"><img src="{{$item->conf_mainproduct_img1}}" class="img-fluid" alt="" style="max-width:228px !important;max-height:228px !important"></a>
                                                                    </div>
                                                                    <div class="back">
                                                                ...
                                                                <div class="product-detail">
                                                                    <div>
                                                                        ...
                                                                        <small>{{ __('validation.home_delivery_in') }} {{number_format($item->timeline_day,0)}} {{ __('validation.unit_day') }}</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        if(parseInt(value.conf_subproduct_days) <= 7){
                            ...
                            <div class="col-xl-3 col-6 col-grid-box" style="display: block;">
                                                            <div class="product-box">
                                                                <div class="img-wrapper">
                                                                    <div class="front">
                                                                        <a href="/{{ app()->getLocale() }}/product/${value.conf_mainproduct_id}/-" class="bg-size" style="background-image: url(&quot;${value.conf_mainproduct_img1}&quot;); background-size: cover; background-position: center center; display: block;max-width:228px !important;max-height:228px !important;"><img src="${value.conf_mainproduct_img1}" class="img-fluid  lazyload bg-img" alt="" style="display: none;"></a>
                                                                    </div>
                                                                    <div class="back">
                                                                    <a href="/{{ app()->getLocale() }}/product/${value.conf_mainproduct_id}/-" class="bg-size" style="background-image: url(&quot;${value.conf_mainproduct_img2}&quot;); background-size: cover; background-position: center center; display: block;max-width:228px !important;max-height:228px !important;"><img src="${value.conf_mainproduct_img2}" class="img-fluid  lazyload bg-img" alt="" style="display: none;"></a>
                                                                    </div>
                                                                ...
                                                                <div class="product-detail">
                                                                    <div>
                                                                        ...
                                                                        <small>${value.conf_subproduct_quota} {{ __('validation.unit_piece') }}</small>
                                                                        <small>${value.conf_subproduct_days} {{ __('validation.unit_day') }}</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>`
