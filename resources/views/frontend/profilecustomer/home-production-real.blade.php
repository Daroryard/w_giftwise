                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <span class="product-tag link-real-all">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-active">แสดงทั้งหมด</span>
                            @else
                            <span class="badge badge-active">Show all</span>
                            @endif
                        </span>
    ...
    productDetail = (ref) => {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                let date = moment(data[0].sal_confirmorder_hd_date).format('DD MMM YYYY');
                $('#date_docs').html(date);
