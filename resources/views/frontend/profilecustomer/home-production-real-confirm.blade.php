...
<div class="main-container">
    ...
    <div class="main">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="page-title">
                            <h3 class="text-black">
                                @if (app()->getLocale() == 'th')
                                สินค้าที่กำลังผลิตทั้งหมด ({{ $count_confirm }} รายการ)
                                @else
                                All products in production ({{ $count_confirm }} items)                         
                                @endif
                            </h3>
                        </div>
                        <span class="product-tag link-real-all">
                            @if (app()->getLocale() == 'th')
                        ...
                        <span class="product-tag link-real-wait">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-none">อยู่ระหว่างผลิต</span>
                            @else
                            <span class="badge badge-none">In production</span>
                            @endif
                        </span>
                        <span class="product-tag link-real-confirm">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-active">รอยืนยันรับสินค้า</span>
                            @else
                            <span class="badge badge-active">Waiting for confirmation</span>
                            @endif
                        </span>
                        <span class="product-tag link-real-edit">
                            @if (app()->getLocale() == 'th')
        ...
        <div class="product-wrapper-grid">
            ...
            @foreach($production_real as $product)
                <div class="col-lg-3 col-6 col-grid-box">
                    <div class="productbox">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#" onclick="productDetail()"><img src="{{ asset($product->sal_confirmorder_dt_imgpic) }}" class="img-fluid customer-product" alt=""></a>
                            </div>                      
                        </div>
                ...
                <div class="modal-bg">
                  ...
                  <div class="offer-content row">
                    ...
                    <div class="product-slick">
                            <div><img src="https://erp.giftwise.co.th/assets/images/products/IMG_20240213041842_P40Wf.png" alt=""
                                    class="img-fluid"></div>
                            <div><img src="https://erp.giftwise.co.th/assets/images/products/IMG_20240213041842_P40Wf.png" alt=""
                                    class="img-fluid"></div>
                            <div><img src="https://erp.giftwise.co.th/assets/images/products/IMG_20240213041842_P40Wf.png" alt=""
                    ...
                    <div class="col-7">
                      <div class="offer-content-box">
                        <span><h3>ขวดน้ำสแตนเลสมินิมอลแบบมีหูจับ ก้นขวดแสตนเลส</h3> <h6>รหัสสินค้า: GS026-S</h6></span>
                        <hr>
                        <h4>รีวิวสินค้า</h4>
                        <div class="rating">
                           <h5>คะแนน
...
<script>
    ...
    $(document).ready(function() {
        $('.menu-cus6').removeClass('option');
        $('.menu-cus6').addClass('option1');
    });


    $('.link-real-all').click(function() {
        location.href = "/{{ app()->getLocale() }}/customer/production-real";
    });
    $('.link-real-wait').click(function() {
        location.href = "/{{ app()->getLocale() }}/customer/production-real-wait";
    });
    $('.link-real-confirm').click(function() {
        location.href = "/{{ app()->getLocale() }}/customer/production-real-confirm";
    });
    $('.link-real-edit').click(function() {
        location.href = "/{{ app()->getLocale() }}/customer/production-real-edit";
    });
