                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <span class="product-tag link-confirm">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-none">รอการยืนยัน</span>
                            @else
                ...
                <div class="col-lg-3 col-6 col-grid-box">
                    <div class="productbox">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="https://erp.giftwise.co.th/{{$product->sal_confirmorder_dt_imgpic}}" class="img-fluid customer-product" alt=""></a>
                            </div>                      
                        </div>
