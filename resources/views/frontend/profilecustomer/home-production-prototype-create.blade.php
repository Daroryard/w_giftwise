                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <span class="product-tag link-prototype-create">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-active">กำลังสร้างต้นแบบ</span>
                            @else
                            <span class="badge badge-active">Creating prototype</span>
                            @endif
                        </span>
                        <span class="product-tag link-prototype-wait">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-none">รอยืนยันต้นแบบ</span>
                            @else
                            <span class="badge badge-none">Waiting for prototype confirmation</span>
                            @endif
                        </span>
