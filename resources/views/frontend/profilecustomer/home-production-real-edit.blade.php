                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <span class="product-tag link-real-confirm">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-none">รอยืนยันรับสินค้า</span>
                            @else
                            <span class="badge badge-none">Waiting for confirmation</span>
                            @endif
                        </span>
                        <span class="product-tag link-real-edit">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-active">รอแก้ไข</span>
                            @else
                            <span class="badge badge-active">Waiting for edit</span>
                            @endif
                        </span>
