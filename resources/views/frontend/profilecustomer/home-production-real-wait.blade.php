                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <span class="product-tag link-real-wait">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-active">อยู่ระหว่างผลิต</span>
                            @else
                            <span class="badge badge-active">In production</span>
                            @endif
                        </span>
    ...
    productDetail = (ref) => {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                let date = moment(data.sal_confirmorder_hd_date).format('DD MMM YYYY');
                $('#date_docs').html(date);
