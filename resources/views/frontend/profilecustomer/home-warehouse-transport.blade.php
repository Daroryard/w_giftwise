                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <span class="product-tag link-in">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-active">ที่ต้องจัดส่ง</span>
                            @else
                            <span class="badge badge-active">To be delivered</span>
                            @endif
                        </span>
                        <span class="product-tag link-success">
                            @if (app()->getLocale() == 'th')
                            <span class="badge badge-none">จำส่งสำเร็จ</span>
                            @else
                            <span class="badge badge-none">Delivered</span>
                            @endif
                        </span>                     
                    </div>                     
                    <div class="col-sm-6">
